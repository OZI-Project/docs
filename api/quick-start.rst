...
.. card::
   ...
   .. card:: :octicon:`terminal;1.5em;sd-text-info` Create the new project.
      ...
      .. command-output:: ozi-new project --name=PROJECT_NAME --author=AUTHOR --author-email=EMAIL --summary=SUMMARY --home-page=HOMEPAGE --license-expression=MIT --license="OSI Approved :: MIT License" TARGET
